...
int ClapTrap::get_hp() const {
	if (_hp < 1)
		...
		std::cout << "ClapTrap " << _name << " has " << _hp << " hit points!" << std::endl;
	return _hp;
}
...
int ClapTrap::get_ep() const {
	...
	if (_ep < 1)
		...
		std::cout << "ClapTrap " << _name << " has " << _ep << " energy points!" << std::endl;
	return _ep;
}
...
int ClapTrap::get_attack_damage() const {
	...
	std::cout << "ClapTrap " << _name << " has " << _attack_damage << " attack damage!" << std::endl;
...
void ClapTrap::set_hp(int hp) {
	...
	_hp = hp;
	std::cout << "ClapTrap " << _name << " now has " << _hp << " hit points!" << std::endl;
}
...
void ClapTrap::set_ep(int ep) {
	...
	_ep = ep;
	std::cout << "ClapTrap " << _name << " now has " << _ep << " energy points!" << std::endl;
}
...
void ClapTrap::set_name(t_string name) {
	...
	std::cout << "ClapTrap " << _name << " is now named " << name << std::endl;
	_name = name;
}
